/*
	** Ethernet - Frames:
	...
	-------------------------
	|			|
	|	Preabmle	|	7 byte will be filtered out by ENC28J60 / MAC
	|			|
	-------------------------
	|  startframedelimiter	|	1 byte will be filtered out by ENC28J60 / MAC
	-------------------------
	|			|
	|	Destination	|	
	|	  Adress	|	6 byte
	...
	|			|
	~			~
		   DATA			46 - 1500 byte, with padding(optional)	
	~	  		~
	|			|
	-------------------------
	|	Frame Check	|	4 byte checksum
	|	Sequence CRC	|
	-------------------------
*/
	...
	#define EPKTCNT         (0x19)
/*
	this was the original-section. same goes for the banks2 & 3
	hglanzer thinks: this sucks...
	can't see meaning. doesn't make bank-switching easier...
