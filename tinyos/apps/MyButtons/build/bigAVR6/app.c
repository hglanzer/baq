...
extern void *memset(void *arg_0x2b68ad0617f0, int arg_0x2b68ad061a58, size_t arg_0x2b68ad061d00);
...
typedef int (*__compar_fn_t)(const void *arg_0x2b68ad082968, const void *arg_0x2b68ad082c40);
...
typedef TMilli MyButtonsC__Timer0__precision_tag;
...
static void MyButtonsC__Timer0__fired(void );
# 60 "/homes/mhartmann/baq/tinyos/tos/interfaces/Boot.nc"
static void MyButtonsC__Boot__booted(void );
# 38 "/homes/mhartmann/baq/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64.nc"
static void MyButtonsC__LCD128x64__initDone(void );
...
static void MyButtonsC__LCD128x64__barWritten(void );

static void MyButtonsC__LCD128x64__screenCleared(void );
#line 46
static void MyButtonsC__LCD128x64__lineWritten(void );
#line 40
static void MyButtonsC__LCD128x64__circleWritten(void );



static void MyButtonsC__LCD128x64__rectangleWritten(void );
#line 42
static void MyButtonsC__LCD128x64__stringWritten(void );
# 75 "/homes/mhartmann/baq/tinyos/tos/interfaces/TaskBasic.nc"
...
# 64 "/homes/mhartmann/baq/tinyos/tos/lib/timer/Timer.nc"
static void MyButtonsC__Timer0__startPeriodic(uint32_t dt);
# 44 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
static void MyButtonsC__Button2__makeInput(void );
#line 43
static bool MyButtonsC__Button2__get(void );
# 32 "/homes/mhartmann/baq/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64.nc"
static void MyButtonsC__LCD128x64__startWriteString(char *data, uint8_t x, uint8_t y);
#line 4
static void MyButtonsC__LCD128x64__initLCD(uint8_t pattern);
# 44 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
static void MyButtonsC__Button3__makeInput(void );
#line 43
static bool MyButtonsC__Button3__get(void );
static void MyButtonsC__Button1__makeInput(void );
#line 43
static bool MyButtonsC__Button1__get(void );
# 14 "MyButtonsC.nc"
static inline void MyButtonsC__Boot__booted(void );
#line 26
static inline void MyButtonsC__Timer0__fired(void );
#line 63
static inline void MyButtonsC__LCD128x64__initDone(void );




static inline void MyButtonsC__LCD128x64__barWritten(void );


static inline void MyButtonsC__LCD128x64__screenCleared(void );


static inline void MyButtonsC__LCD128x64__lineWritten(void );


static inline void MyButtonsC__LCD128x64__circleWritten(void );


static inline void MyButtonsC__LCD128x64__rectangleWritten(void );


static inline void MyButtonsC__LCD128x64__stringWritten(void );
# 38 "/homes/mhartmann/baq/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64.nc"
...
enum LCD128x64P____nesc_unnamed4301 {
#line 37
...
#line 53
# 32 "/homes/mhartmann/baq/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64.nc"
inline static void MyButtonsC__LCD128x64__startWriteString(char *data, uint8_t x, uint8_t y){
#line 32
...
inline static bool MyButtonsC__Button3__get(void ){
#line 43
  unsigned char result;
#line 43
...
# 43 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
inline static bool MyButtonsC__Button2__get(void ){
#line 43
  unsigned char result;
#line 43
...
# 43 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
inline static bool MyButtonsC__Button1__get(void ){
#line 43
  unsigned char result;
#line 43
...
#line 26
{
  ...
  if (MyButtonsC__Button1__get() == TRUE) {

      MyButtonsC__LCD128x64__startWriteString("1", 0, 2);
    }
  else {

      MyButtonsC__LCD128x64__startWriteString("-", 0, 2);
    }




  if (MyButtonsC__Button2__get() == TRUE) {

      MyButtonsC__LCD128x64__startWriteString("2", 0, 3);
    }
  else {

      MyButtonsC__LCD128x64__startWriteString("-", 0, 3);
    }



  if (MyButtonsC__Button3__get() == TRUE) {

      MyButtonsC__LCD128x64__startWriteString("3", 0, 4);
    }
  else {

      MyButtonsC__LCD128x64__startWriteString("-", 0, 4);
    }
}
...
# 83 "/homes/mhartmann/baq/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b68ad5fbda0){
#line 83
  switch (arg_0x2b68ad5fbda0) {
#line 83
    case 0U:
#line 83
      MyButtonsC__Timer0__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b68ad5fbda0);
#line 83
      break;
#line 83
    }
...
#line 48
  MyButtonsC__LCD128x64__barWritten();
#line 48
}
#line 48
...
#line 46
  MyButtonsC__LCD128x64__lineWritten();
#line 46
}
#line 46
...
#line 50
  MyButtonsC__LCD128x64__screenCleared();
#line 50
}
#line 50
...
#line 42
  MyButtonsC__LCD128x64__stringWritten();
#line 42
}
#line 42
...
#line 40
  MyButtonsC__LCD128x64__circleWritten();
#line 40
}
#line 40
...
#line 44
  MyButtonsC__LCD128x64__rectangleWritten();
#line 44
}
#line 44
...
# 64 "/homes/mhartmann/baq/tinyos/tos/lib/timer/Timer.nc"
inline static void MyButtonsC__Timer0__startPeriodic(uint32_t dt){
#line 64
...
# 44 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
inline static void MyButtonsC__Button3__makeInput(void ){
#line 44
...
# 44 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
inline static void MyButtonsC__Button2__makeInput(void ){
#line 44
...
# 44 "/homes/mhartmann/baq/tinyos/tos/interfaces/GeneralIO.nc"
inline static void MyButtonsC__Button1__makeInput(void ){
#line 44
...
#line 63
{
  ...
  MyButtonsC__LCD128x64__startWriteString("Button Test ...", 0, 0);
}

# 38 "/homes/mhartmann/baq/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64.nc"
inline static void LCD128x64P__LCD128x64__initDone(void ){
#line 38
  MyButtonsC__LCD128x64__initDone();
#line 38
}
#line 38
...
inline static void MyButtonsC__LCD128x64__initLCD(uint8_t pattern){
#line 4
...
#line 14
{
  ...
  MyButtonsC__LCD128x64__initLCD(0x00);

  MyButtonsC__Button1__makeInput();
  MyButtonsC__Button2__makeInput();
  MyButtonsC__Button3__makeInput();

  MyButtonsC__Timer0__startPeriodic(200);
}

# 60 "/homes/mhartmann/baq/tinyos/tos/interfaces/Boot.nc"
inline static void RealMainP__Boot__booted(void ){
#line 60
  MyButtonsC__Boot__booted();
#line 60
}
#line 60
...
# 75 "/homes/mhartmann/baq/tinyos/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b68ad18a108){
#line 75
  switch (arg_0x2b68ad18a108) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2b68ad18a108);
#line 75
      break;
#line 75
    }
