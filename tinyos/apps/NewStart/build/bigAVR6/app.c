...
extern void *memset(void *arg_0x2b0f560527f0, int arg_0x2b0f56052a58, size_t arg_0x2b0f56052d00);
...
typedef int (*__compar_fn_t)(const void *arg_0x2b0f56073968, const void *arg_0x2b0f56073c40);
...
# 64 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64.h"
...
#line 50
static void BlinkC__LCD128x64__screenCleared(void );
#line 46
...
# 19 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreen.nc"
static void BlinkC__TouchScreen__tsPressed(void );
#line 17
static void BlinkC__TouchScreen__calibrated(void );
#line 15
static void BlinkC__TouchScreen__xyReady(uint8_t x, uint8_t y);
# 75 "/homes/hglanzer/GIT/tinyos/tos/interfaces/TaskBasic.nc"
...
#line 50
static void TouchScreenP__LCD128x64__screenCleared(void );
#line 46
...
# 8 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreen.nc"
...
# 8 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreen.nc"
static void BlinkC__TouchScreen__isPressed(bool on);
#line 6
static void BlinkC__TouchScreen__getXY(void );
# 30 "BlinkC.nc"
volatile uint8_t BlinkC__tmp = 0;
...
static inline void BlinkC__TouchScreen__tsPressed(void );
...
static inline void BlinkC__LCD128x64__screenCleared(void );
...
# 41 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64P.nc"
...
#line 369
enum LCD128x64P____nesc_unnamed4312 {
#line 369
...
enum /*AlarmCounterMilliP.Atm128AlarmSyncC.Atm128AlarmSyncP*/Atm128AlarmSyncP__0____nesc_unnamed4313 {
...
#line 15
static void TouchScreenP__TouchScreen__xyReady(uint8_t x, uint8_t y);
# 33 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
enum TouchScreenP____nesc_unnamed4318 {
#line 33
  TouchScreenP__checkTS = 9U
};
#line 33
...
#line 30
static volatile uint8_t TouchScreenP__calibrate = FALSE;
#line 30
...
#line 31
static volatile uint16_t TouchScreenP__x_max = 855;
#line 31
static volatile uint16_t TouchScreenP__x_min = 50;
#line 31
static volatile uint16_t TouchScreenP__y_max = 800;
#line 31
static volatile uint16_t TouchScreenP__y_min = 128;
...
static inline void TouchScreenP__calcXY(uint16_t x_raw, uint16_t y_raw);
#line 59
static void TouchScreenP__TouchScreen__getXY(void );
#line 81
...
#line 103
static inline void TouchScreenP__LCD128x64__screenCleared(void );
...
# 88 "/homes/hglanzer/GIT/tinyos/tos/interfaces/Resource.nc"
inline static error_t /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Resource__request(uint8_t arg_0x2b0f56826318){
#line 88
  unsigned char result;
#line 88

#line 88
  switch (arg_0x2b0f56826318) {
#line 88
...
#line 88
    default:
#line 88
      result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Resource__default__request(arg_0x2b0f56826318);
#line 88
      break;
#line 88
    }
...
# 17 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreen.nc"
...
inline static void TouchScreenP__TouchScreen__xyReady(uint8_t x, uint8_t y){
#line 15
  BlinkC__TouchScreen__xyReady(x, y);
#line 15
}
#line 15
# 38 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__calcXY(uint16_t x_raw, uint16_t y_raw)
{
  float x_tmp = 0;
#line 40
  ...
  if (x_raw < TouchScreenP__x_max && x_raw > TouchScreenP__x_min && y_raw < TouchScreenP__y_max && y_raw > TouchScreenP__y_min) 
    {
      ...
      x_tmp = (float )x_raw / (float )820;
      y_tmp = (float )y_raw / (float )672;
      x_tmp = x_tmp * 128;
      y_tmp = y_tmp * 64;
      TouchScreenP__TouchScreen__xyReady(x_tmp, y_tmp);
    }
  else {
    TouchScreenP__TouchScreen__xyReady(200, 200);
    }
}
...
#line 19
  BlinkC__TouchScreen__tsPressed();
#line 19
}
#line 19
# 120 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__Read__readDone(error_t err, uint16_t val)
{
                ...
                if (val > 30) 
                  {
                    if (TouchScreenP__pressDetect == TRUE) 
                      ...
                      {
                        if (TouchScreenP__calibrate == TRUE) 
                          {
                            TouchScreenP__x_min = val;
                          }
                        else 
                          {
                            TouchScreenP__x = val;
...
#line 168
                ...
                if (val > 60) 
                  {
                    if (TouchScreenP__calibrate == TRUE) 
                      {
                        TouchScreenP__state = DUMMY_SECOND_X;
                        * (volatile uint8_t *)0x65 |= 1 << 3;
                        * (volatile uint8_t *)0x65 &= ~(1 << 4);
                        TouchScreenP__channel = ATM128_ADC_SNGL_ADC0;
                        TouchScreenP__y_min = val;
                      ...
                      {
                        TouchScreenP__y = val;
                        TouchScreenP__calcXY(TouchScreenP__x, TouchScreenP__y);
                      }
                  }
                else 
                  {
              ...
              case DUMMY_SECOND_X: 
                TouchScreenP__x_max = val;
              TouchScreenP__state = SECOND_X;
              TouchScreenP__Read__read();
              break;
              ...
              * (volatile uint8_t *)0x65 &= ~(1 << 3);
              TouchScreenP__channel = ATM128_ADC_SNGL_ADC1;
              TouchScreenP__state = DUMMY_SECOND_Y;
              TouchScreenP__Read__read();
              break;

              case DUMMY_SECOND_Y: 
                TouchScreenP__state = SECOND_Y;
              TouchScreenP__Read__read();
              break;

              case SECOND_Y: 
                TouchScreenP__y_max = val;
              if (TouchScreenP__y_max > TouchScreenP__y_min + 100 && TouchScreenP__x_max > TouchScreenP__x_min + 100) 
                {
                  TouchScreenP__state = CALIBRATED;
                  TouchScreenP__calibrate = FALSE;
                  TouchScreenP__LCD128x64__startClearScreen(0x00);
                  TouchScreenP__LCD128x64__startWriteString("CALIBRATION DONE", 12, 16);
...
# 63 "/homes/hglanzer/GIT/tinyos/tos/interfaces/Read.nc"
inline static void /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Read__readDone(uint8_t arg_0x2b0f5682bae0, error_t result, /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Read__val_t val){
#line 63
  switch (arg_0x2b0f5682bae0) {
#line 63
    case /*TouchScreenC.AdcReadClientC*/AdcReadClientC__0__ID:
#line 63
...
#line 63
    default:
#line 63
      /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Read__default__readDone(arg_0x2b0f5682bae0, result, val);
#line 63
      break;
#line 63
    }
...
# 65 "/homes/hglanzer/GIT/tinyos/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x2b0f5679a538){
#line 65
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x2b0f5679a538);
#line 65
}
#line 65
# 67 "/homes/hglanzer/GIT/tinyos/tos/interfaces/TaskBasic.nc"
...
# 120 "/homes/hglanzer/GIT/tinyos/tos/interfaces/Resource.nc"
inline static error_t /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Resource__release(uint8_t arg_0x2b0f56826318){
#line 120
  unsigned char result;
#line 120
...
#line 120
    default:
#line 120
      result = /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Resource__default__release(arg_0x2b0f56826318);
#line 120
      break;
#line 120
    }
...
# 63 "/homes/hglanzer/GIT/tinyos/tos/interfaces/Read.nc"
inline static void AdcP__Read__readDone(uint8_t arg_0x2b0f56808ac0, error_t result, AdcP__Read__val_t val){
#line 63
  /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Service__readDone(arg_0x2b0f56808ac0, result, val);
#line 63
}
#line 63
# 108 "/homes/hglanzer/GIT/tinyos/tos/chips/atm128/adc/AdcP.nc"
...
# 53 "/homes/hglanzer/GIT/tinyos/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x2b0f5679c328){
#line 53
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x2b0f5679c328);
#line 53
}
#line 53
...
# 55 "/homes/hglanzer/GIT/tinyos/tos/interfaces/Read.nc"
inline static error_t /*WireAdcP.ArbitrateRead*/ArbitratedReadC__0__Service__read(uint8_t arg_0x2b0f568297d8){
#line 55
  unsigned char result;
#line 55

#line 55
  result = AdcP__Read__read(arg_0x2b0f568297d8);
#line 55
...
# 102 "/homes/hglanzer/GIT/tinyos/tos/interfaces/Resource.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x2b0f5679d1a0){
#line 102
  switch (arg_0x2b0f5679d1a0) {
#line 102
...
#line 102
    default:
#line 102
      /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x2b0f5679d1a0);
#line 102
      break;
#line 102
    }
...
# 59 "/homes/hglanzer/GIT/tinyos/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x2b0f5679a538){
#line 59
    /*Atm128AdcC.AdcArbiter.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x2b0f5679a538);
#line 59
}
#line 59
...
#line 70
# 288 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline uint8_t TouchScreenP__Atm128AdcConfig__getChannel(void )
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
...
# 25 "/homes/hglanzer/GIT/tinyos/tos/chips/atm128/adc/Atm128AdcConfig.nc"
inline static uint8_t AdcP__Atm128AdcConfig__getChannel(uint8_t arg_0x2b0f56803cd0){
#line 25
  unsigned char result;
#line 25

#line 25
  switch (arg_0x2b0f56803cd0) {
#line 25
    case /*TouchScreenC.AdcReadClientC*/AdcReadClientC__0__ID:
#line 25
...
#line 25
    default:
#line 25
      result = AdcP__Atm128AdcConfig__default__getChannel(arg_0x2b0f56803cd0);
#line 25
      break;
#line 25
    }
...
# 283 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline uint8_t TouchScreenP__Atm128AdcConfig__getRefVoltage(void )
{
  return 1;
}
...
# 32 "/homes/hglanzer/GIT/tinyos/tos/chips/atm128/adc/Atm128AdcConfig.nc"
inline static uint8_t AdcP__Atm128AdcConfig__getRefVoltage(uint8_t arg_0x2b0f56803cd0){
#line 32
  unsigned char result;
#line 32
...
#line 32
    default:
#line 32
      result = AdcP__Atm128AdcConfig__default__getRefVoltage(arg_0x2b0f56803cd0);
#line 32
      break;
#line 32
    }
...
# 296 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline uint8_t TouchScreenP__Atm128AdcConfig__getPrescaler(void )
{
  return ATM128_ADC_PRESCALE_128;
}
...
# 39 "/homes/hglanzer/GIT/tinyos/tos/chips/atm128/adc/Atm128AdcConfig.nc"
inline static uint8_t AdcP__Atm128AdcConfig__getPrescaler(uint8_t arg_0x2b0f56803cd0){
#line 39
  unsigned char result;
#line 39
...
#line 39
    default:
#line 39
      result = AdcP__Atm128AdcConfig__default__getPrescaler(arg_0x2b0f56803cd0);
#line 39
      break;
#line 39
    }
...
static inline void BlinkC__Timer0__fired(void )
{
  BlinkC__LCD128x64__startClearScreen(0x00);
}
...
# 83 "/homes/hglanzer/GIT/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b0f5660bda0){
#line 83
  switch (arg_0x2b0f5660bda0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b0f5660bda0);
#line 83
      break;
#line 83
    }
...
# 81 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__LCD128x64__lineWritten(void )
{
}
...
# 103 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__LCD128x64__screenCleared(void )
{
}
...
#line 50
  TouchScreenP__LCD128x64__screenCleared();
#line 50
  BlinkC__LCD128x64__screenCleared();
#line 50
}
#line 50
# 259 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64P.nc"
static inline void LCD128x64P__clearScreenNB__runTask(void )
{
...
# 89 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__LCD128x64__stringWritten(void )
{
}
...
#line 42
# 230 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64P.nc"
static inline void LCD128x64P__writeString__runTask(void )
{
  uint8_t index = 0;
#line 232
...
# 111 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__LCD128x64__circleWritten(void )
{
}
...
#line 40
# 196 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64P.nc"
static inline void LCD128x64P__writeCircle__runTask(void )
{
  int tswitch;
#line 198
...
# 85 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__LCD128x64__rectangleWritten(void )
{
}
...
#line 44
# 179 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64P.nc"
static inline void LCD128x64P__writeRectangle__runTask(void )
{
  unsigned char j;
...
#line 62
# 265 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__TouchScreen__isPressed(bool on)
{
...
# 8 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreen.nc"
inline static void BlinkC__TouchScreen__isPressed(bool on){
#line 8
...
static inline void BlinkC__LCD128x64__initDone(void )
{
  ...
  BlinkC__TouchScreen__isPressed(TRUE);
}

# 107 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static inline void TouchScreenP__LCD128x64__initDone(void )
{
}
...
# 66 "/homes/hglanzer/GIT/tinyos/tos/interfaces/ReadNow.nc"
inline static void AdcP__ReadNow__readDone(uint8_t arg_0x2b0f568056d8, error_t result, AdcP__ReadNow__val_t val){
#line 66
    AdcP__ReadNow__default__readDone(arg_0x2b0f568056d8, result, val);
#line 66
}
#line 66
# 67 "/homes/hglanzer/GIT/tinyos/tos/interfaces/TaskBasic.nc"
...
# 75 "/homes/hglanzer/GIT/tinyos/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b0f5617b108){
#line 75
  switch (arg_0x2b0f5617b108) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2b0f5617b108);
#line 75
      break;
#line 75
    }
...
# 59 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/TouchScreen/TouchScreenP.nc"
static void TouchScreenP__TouchScreen__getXY(void )
{
  TouchScreenP__state = DUMMY_FIRST_X;
  * (volatile uint8_t *)0x64 |= 1 << 4;
  * (volatile uint8_t *)0x64 |= 1 << 3;

  * (volatile uint8_t *)0x61 &= ~(1 << 1);
  * (volatile uint8_t *)0x61 &= ~(1 << 0);

  * (volatile uint8_t *)0x62 &= ~(1 << 0);
  * (volatile uint8_t *)0x62 &= ~(1 << 1);
...
# 518 "/homes/hglanzer/GIT/tinyos/tos/platforms/bigAVR6/lcd128x64/LCD128x64P.nc"
static error_t LCD128x64P__LCD128x64__startClearScreen(uint8_t pattern)
{
#line 532
  LCD128x64P__state = LCD128x64P__state | BUSY_CLEAR;
...
static void BlinkC__TouchScreen__xyReady(uint8_t x, uint8_t y)
{
  ...
  BlinkC__LCD128x64__startWriteString(BlinkC__buf, 45, 40);
#line 84
  BlinkC__TouchScreen__isPressed(TRUE);
}
