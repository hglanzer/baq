...
typedef TMilli LedC__Timer0__precision_tag;
typedef TMilli LedC__Timer1__precision_tag;
...
#line 14
static void LedC__LCD128x64__setPixel(uint8_t x, uint8_t y);
#line 12
...
#line 35
typedef int LedC____nesc_sillytask_runTasks[LedC__runTasks];
#line 30
volatile uint8_t LedC__count = 0;
#line 30
volatile uint8_t LedC__count2 = 0;
#line 30
volatile uint8_t LedC__up = 1;




static inline void LedC__runTasks__runTask(void );
#line 69
static inline void LedC__Boot__booted(void );
#line 94
static inline void LedC__Timer1__fired(void );
...
#line 67
  result = SchedulerBasicP__TaskBasic__postTask(LedC__runTasks);
#line 67
...
static inline void LedC__runTasks__runTask(void )
{
  LedC__LCD128x64__startClearScreen(0x00);




  LedC__LCD128x64__startWriteLine(0, 31, 127, LedC__count);
...
#line 64
inline static void LedC__Timer0__startPeriodic(uint32_t dt){
#line 64
...
inline static void LedC__LCD128x64__setPixel(uint8_t x, uint8_t y){
#line 14
...
static inline void LedC__LCD128x64__initDone(void )
{
  LedC__LCD128x64__setPixel(0, 0);
  LedC__LCD128x64__setPixel(0, 2);
  LedC__LCD128x64__setPixel(0, 4);
  LedC__LCD128x64__setPixel(0, 6);
  LedC__LCD128x64__setPixel(0, 8);
  LedC__LCD128x64__setPixel(0, 9);
  LedC__LCD128x64__setPixel(0, 12);
  LedC__LCD128x64__setPixel(0, 14);
  LedC__LCD128x64__setPixel(0, 31);

  LedC__LCD128x64__writePixel(0, 0, FALSE);
